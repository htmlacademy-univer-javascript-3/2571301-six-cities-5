...
import UserHeaderInfo from '../user-header-info/user-header-info.tsx';
...
import { fetchComments, fetchOffer, fetchOfferNeibourhood, postComment } from '../../store/api-actions.ts';
