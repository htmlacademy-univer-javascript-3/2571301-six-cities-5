...
import { dataProcessInitialStateMock, mockCommentList, mockOffer, mockOfferList } from '../../mocks/store-mocks.ts';
import {dataProcess} from './data-process.ts';
import '@testing-library/jest-dom';
import { fetchComments, fetchOffer, fetchOfferNeibourhood, fetchOffers, getFavourites } from '../api-actions.ts';
