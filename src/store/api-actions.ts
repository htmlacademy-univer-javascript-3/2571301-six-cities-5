...
import {OfferDescription, OfferIdDescription} from '../types/offer-description.js';
import {redirectToRoute} from './city-action.js';
import {APIRoute} from '../mocks/api-routes.js';
